...
import com.example.reviv.jumper.framework.Music;
import com.example.reviv.jumper.framework.Sound;
import com.example.reviv.jumper.framework.gl.Animation;
import com.example.reviv.jumper.framework.gl.Font;
...
public class Assets {
    ...
    public static void load(GLGame game)
    {
        ...
        backgroundRegion=new TextureRegion(items,0,244,300,110);
